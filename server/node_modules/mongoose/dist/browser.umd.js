 ...
 * ignore
 */
W.prototype.$__init=function(t,e){if(this.isNew=!1,this.$init=!0,e=e||{},null!=t._id&&e.populated&&e.populated.length)for(var r=String(t._id),n=0;n<e.populated.length;++n){var i=e.populated[n];i.isVirtual?this.populated(i.path,P.getValue(i.path,t),i):this.populated(i.path,i._docs[r],i)}
/*!
 * Init helper.
 *
...
/*!
 * ignore
 */var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};t.exports=function(t){return null==t||("object"!==(void 0===t?"undefined":n(t))||!("$meta"in t||"$slice"in t))}},function(t,e,r){"use strict";t.exports=r(93)},function(t,e,r){"use strict";(function(n){r(14).set(r(97));var i=r(61),o=r(66);i.setBrowser(!0),Object.defineProperty(e,"Promise",{get:function(){return o.get()},set:function(t){o.set(t)}}),e.PromiseProvider=o,e.Error=r(4),e.Schema=r(52),e.Types=r(57),e.VirtualType=r(53),e.SchemaType=r(7),e.utils=r(2),e.Document=i(),e.model=function(){return null},
/*!
 * Module exports.
 */
